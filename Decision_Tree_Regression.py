...
# We are creating our decision tree regressor model.

clf = clf.fit(x_train,y_train) 
# We are training our data model with x_train and y_train. We will use this model to predict:
# ... x_test and y_test.

print('Test score:', clf.score(x_test, y_test)) 
# We are measuring the accuracy of our model based on x_train and y_train.
